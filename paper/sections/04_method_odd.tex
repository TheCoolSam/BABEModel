...
\end{equation}
where $\alpha \geq 0$ is the trust influence coefficient (\texttt{TRUST\_INFLUENCE} = 0.3) and $T_{ij} \in [0, 1]$ is the current dyadic trust. The trust buffer represents the psychological mechanism of ``friends can argue'': a high level of interpersonal trust shifts the influence weight upward, preventing disagreements from immediately deteriorating into hostile backfires.
